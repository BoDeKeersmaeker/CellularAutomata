...
public class MeshGenerator3D : MonoBehaviour
{
    ...
    //        Squares = new Square[nodeCountX - 1, nodeCountY - 1, nodeCountZ-1];
    //        for (int x = 0; x < nodeCountX - 1; x++)
    //            for (int y = 0; y < nodeCountY - 1; y++)
    //                for (int z = 0; z < nodeCountZ - 1; z++)
    //                {
    //                    Squares[x, y, z] = new Square(controlNodes[x, y + 1], controlNodes[x + 1, y + 1], controlNodes[x + 1, y], controlNodes[x, y]);
    //                }
    //    }
    //}
